...
namespace Microsoft.AspNetCore.Components.Web.DragAndDrop
{
    public class Drag<TItem> : ComponentBase, IAsyncDisposable
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _id = await JSRuntime.InvokeAsync<long>(DragAndDropInterop.RegisterDragDotNetHelper, interopHandleReference);
        }
        ...
        public ValueTask DisposeAsync()
        {
            ...
            return JSRuntime.InvokeVoidAsync(DragAndDropInterop.UnregisterDragDotNetHelper, _id);
        }
    }
}
